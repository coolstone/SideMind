...
assert.match(sidepanelSource, /function openShareDialog/);
assert.match(sidepanelSource, /function buildShareConversationGroups/);
assert.match(sidepanelSource, /function handleShareConversationSelection/);
assert.match(sidepanelSource, /shareSelectedGroupIds/);
assert.match(sidepanelSource, /dataset\.shareMessageId/);
assert.match(sidepanelSource, /function buildSharePayload/);
assert.match(sidepanelSource, /function invalidateSharePreview/);
assert.match(sidepanelSource, /sharePreviewAsset/);
assert.match(sidepanelSource, /正在本地生成 PNG 预览/);
assert.match(sidepanelSource, /实际 PNG 的本地预览，尚未下载/);
assert.match(sidepanelSource, /skipPreviewCache/);
assert.match(sidepanelSource, /async function createShareImageBlob/);
assert.match(sidepanelSource, /function wrapCanvasText/);
assert.match(sidepanelSource, /function prepareMarkdownCanvasBlocks/);
assert.match(sidepanelSource, /function parseMarkdownCanvasBlocks/);
assert.match(sidepanelSource, /function drawMarkdownCanvasBlock/);
assert.match(sidepanelSource, /heading1/);
assert.match(sidepanelSource, /type: "quote"/);
assert.match(sidepanelSource, /type: "code"/);
assert.match(sidepanelSource, /text\/markdown;charset=utf-8/);
assert.match(sidepanelSource, /new ClipboardItem\(\{ "image\/png": asset\.blob \}\)/);
assert.match(sidepanelSource, /service\.weibo\.com\/share\/share\.php/);
assert.match(sidepanelSource, /x\.com\/intent\/post/);
assert.match(sidepanelSource, /微信无法直接发送/);
...
assert.match(sidepanelSource, /async function deleteUserQuestionGroup/);
assert.match(sidepanelSource, /删除问题及对应答案/);
assert.match(sidepanelSource, /确定删除这条问题及其/);
assert.match(sidepanelSource, /async function editUserQuestion/);
assert.match(sidepanelSource, /function currentPromptCharacterLimit/);
assert.match(sidepanelSource, /已达到问题上限/);
assert.match(sidepanelSource, /ui\.promptInput\.maxLength = limit/);
assert.match(sidepanelSource, /ui\.promptLimitHint\.hidden = true/);
...
assert.match(sidepanelSource, /async function setHistoryFilter/);
assert.match(sidepanelSource, /async function toggleConversationFavorite/);
assert.match(sidepanelSource, /async function deleteConversationFromHistory/);
assert.match(sidepanelSource, /favorite: Boolean\(previous\?\.favorite\)/);
assert.match(sidepanelSource, /聊天内容和关联工件将被删除/);
...
assert.match(sidepanelStyle, /\.content-area \{ min-width:0; min-height:0; overflow-x:hidden/);
assert.match(sidepanelStyle, /\.message-bubble pre \{ max-width:100%; overflow-x:hidden/);
assert.match(sidepanelStyle, /white-space:pre-wrap/);
assert.match(sidepanelStyle, /overflow-wrap:anywhere/);
assert.match(sidepanelStyle, /\.prompt-limit-hint\[hidden\] \{ display:none!important; \}/);
assert.match(sidepanelStyle, /\.share-preview-image/);
...
assert.match(sidepanelHtml, /id="shareDialog"/);
assert.match(sidepanelHtml, /id="promptLimitHint"[^>]*hidden/);
assert.match(sidepanelHtml, /id="historyAllButton"/);
assert.match(sidepanelHtml, /id="historyFavoritesButton"/);
assert.match(sidepanelHtml, /id="shareConversationList"/);
assert.match(sidepanelHtml, /id="shareSelectAllButton"/);
assert.match(sidepanelHtml, /选择任一问题或回答，会自动选中该轮完整对话/);
assert.match(sidepanelHtml, /id="shareFormatImage"/);
assert.match(sidepanelHtml, /id="shareFormatMarkdown"/);
assert.match(sidepanelHtml, /Markdown<\/b><small>\.md 文件/);
